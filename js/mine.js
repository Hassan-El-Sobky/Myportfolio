...
let countNum = noMessage.getAttribute('maxlenght')
console.log(countNum)
userMessage.oninput=function()
{
   noMessage.textContent=countNum-this.value.length;
}
...
$(window).scroll(function(){
  ...
  var windowScroll =$(window).scrollTop();
      ...
      if(windowScroll +500 > contactOffset)
      {
        $('.sctop').css('color','#faed26')
      
      }
      else
      {
        $('.sctop').css('color','black')
      }
